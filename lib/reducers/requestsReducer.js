    ...
    case _requestsActions.REQUEST_SUCCESS:
      {
        ...
        return (0, _extends8.default)({}, state, (0, _defineProperty3.default)({}, requestKey, (0, _extends8.default)({}, state[requestKey], _data, {
          loading: false,
    ...
    case _requestsActions.REQUEST_SUBSCRIPTION_ACTION:
      {
        ...
        var updateIncluded = function updateIncluded(newIncluded, data, included) {
          return [].concat((0, _toConsumableArray3.default)(newIncluded), (0, _toConsumableArray3.default)(included)).reduce(function (acc, record) {
            return _ramda2.default.find(_ramda2.default.whereEq(_ramda2.default.pick(['id', 'type'], record)), acc) ? acc : [].concat((0, _toConsumableArray3.default)(acc), [record]);
          }, []);
        };
        ...
        if (sAction === 'destroy') {
          ...
          updateIncluded = function updateIncluded(newIncluded, data, included) {
            return newIncluded.filter(_ramda2.default.whereEq(_ramda2.default.pick(['id', 'type'], _ramda2.default.__))(included));
          };
        }
        if (sAction === 'update') {
          updateData = function updateData(newData, data) {
            ...
            return _ramda2.default.update(index, (0, _extends8.default)({}, newData, { attributes: (0, _extends8.default)({}, data[index].attributes, newData.attributes) }), data);
          };
        }
