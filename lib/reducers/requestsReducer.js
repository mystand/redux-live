    ...
    case _requestsActions.REQUEST_SUBSCRIPTION_ACTION:
      {
        ...
        if (sAction === 'create') fn = function fn(object) {
          return function (data) {
            return [].concat((0, _toConsumableArray3.default)(data), [object]);
          };
        };
        if (sAction === 'destroy') fn = function fn(object) {
          return function (data) {
          ...
          fn = function fn(object) {
            return function (data) {
              if (data.id) {
                ...
                return (0, _extends8.default)({}, object, { attributes: (0, _extends8.default)({}, data.attributes, object) });
              }
              ...
              return _ramda2.default.update(index, (0, _extends8.default)({}, object, { attributes: (0, _extends8.default)({}, data[index].attributes) }), data);
            };
          };
        }
        ...
        if (fn != null) {
          ...
          return (0, _extends8.default)({}, state, (0, _defineProperty3.default)({}, _requestKey, (0, _extends8.default)({}, object, {
            data: fn(object.data)(_ramda2.default.clone(state[_requestKey].data))
