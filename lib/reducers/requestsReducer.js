    ...
    case _requestsActions.REQUEST_SUCCESS:
      {
        ...
        }, _data.included && { included: mergeData(state[requestKey].included, _data.included, merge, comparator) }, {
          dataError: null
    ...
    case _requestsActions.REQUEST_SUBSCRIPTION_ACTION:
      {
        ...
        if (sAction === 'create') fn = function fn(data, object) {
          return [].concat((0, _toConsumableArray3.default)(data), [object]);
        };
        if (sAction === 'destroy') fn = function fn(data, object) {
          return data.filter(function (x) {
            return x.id !== object.id;
          });
        };
        if (sAction === 'update') {
          fn = function fn(data, object) {
            if (data.id) {
              return object;
            }
          ...
          if (_comparator != null) {
            ...
            fn = function fn(object) {
              return function (data) {
                return _ramda2.default.sort(_comparator, fnOld(data, object));
              };
            };
          }

          return (0, _extends8.default)({}, state, (0, _defineProperty3.default)({}, _requestKey, (0, _extends8.default)({
            data: updatePath('data', fn(object.data), state[_requestKey]),
            included: updatePath('included', fn(object.included), state[_requestKey])
          }, _ramda2.default.omit(['data', 'included'], object))));
        }
