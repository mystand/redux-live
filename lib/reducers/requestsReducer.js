    ...
    case _requestsActions.REQUEST_SUBSCRIPTION_ACTION:
      {
        ...
        if (fn != null) {
          var newState = updatePath([_requestKey, 'data'], fn, state);
          return _comparator == null ? newState : _ramda2.default.sort(_comparator, newState);
        }
...
function mergeData(oldData, newData) {
  ...
  if (type === 'replace') return comparator == null ? newData : _ramda2.default.sort(comparator, newData);
  if (type === 'append') {
