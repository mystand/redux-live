    ...
    case _requestsActions.REQUEST_SUBSCRIPTION_ACTION:
      {
        ...
        var updateIncluded = function updateIncluded(newIncluded, data, included) {
          return _ramda2.default.dropRepeatsWith(function (x1, x2) {
            return _ramda2.default.eqProps('id', x1, x2) && _ramda2.default.eqProps('type', x1, x2);
          }, [].concat((0, _toConsumableArray3.default)(newIncluded), (0, _toConsumableArray3.default)(included)));
        };
