...
if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_SubscribeOptionsType', {
  value: require('react').PropTypes.shape({
...
if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_RequestDeclarationItemType', {
  value: require('react').PropTypes.shape({
    ...
    subscribe: require('react').PropTypes.bool
  })
});
      ...
      _createClass(WithRequests, [{
        ...
        value: function componentDidMount() {
          ...
          if (wrappedComponent == null) {
            ...
            this.connectComponent.componentWillUpdate = function (nextProps, nextState) {
              _this2._performRequestsIfNeeded(nextProps, null);
            ...
            this._performRequestsIfNeeded(this.props, _state);
          }
        }
      }, {
        ...
        value: function _performRequestsIfNeeded(props, state) {
          ...
          requestsDeclaration.forEach(function (request) {
            ...
            var previousCacheKey = _this4._requestsCacheKeys[key];
            ...
            if (previousCacheKey !== cacheKey) {
              ...
              var _action = _extends({}, actionCreator(props, state), { requestKey: requestKey });
              if (subscribe) {
                _action = _extends({}, _action, {
                  options: _extends({}, _action.options, {
                    subscribe: { params: _action.params, model: (0, _pluralize2.default)(_action.dataType, 1) }
                  })
                });
              }
              dispatch(_action);
