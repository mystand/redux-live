...
var error = exports.error = function error(requestKey, data, status, options, dataType, method, params) {
  return {
    type: REQUEST_ERROR, requestKey: requestKey, data: data, status: status, options: options, dataType: dataType, method: method, params: params
  };
};
