...
var babelPluginFlowReactPropTypes_proptype_RequestSuccessActionType = require('../actions/requestsActions').babelPluginFlowReactPropTypes_proptype_RequestSuccessActionType || require('react').PropTypes.any; // eslint-disable-line no-duplicate-imports
...
function buildRequestsSaga(Api, dispatch) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            _context.next = 11;
            return (0, _effects.put)(requestsActions.error(requestKey, data, status));
          ...
          case 13:
            _context.next = 15;
            return (0, _effects.put)(requestsActions.success(requestKey, data, options));
          ...
          case 17:
            ...
            _context.next = 21;
            return (0, _effects.put)(requestsActions.failure(requestKey, _context.t0));
  ...
  function createSubscriptionIfNeeded(action) {
    ...
    if (options != null && options.subscribe != null) {
      ...
      subscriptions[requestKey] = new _Subscription2.default(model, condition, function (sAction, object) {
        dispatch(requestsActions.subscriptionAction(requestKey, sAction, object, { comparator: comparator }));
      });
    ...
    return regeneratorRuntime.wrap(function requestSaga$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _effects.takeLatest)(requestsActions.REQUEST_START, start);

          case 2:
            _context2.next = 4;
            return (0, _effects.takeLatest)(requestsActions.REQUEST_SUCCESS, createSubscriptionIfNeeded);

          case 4:
            _context2.next = 6;
            return (0, _effects.takeLatest)(requestsActions.REQUEST_CLEAR, clearSubscriptionIfNeeded);
